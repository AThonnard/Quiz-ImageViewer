...
image_no_1 = ImageTk.PhotoImage(Image.open("Paris.jpg"))
image_no_2 = ImageTk.PhotoImage(Image.open("Tokio.jpg"))
image_no_3 = ImageTk.PhotoImage(Image.open("Mumbai.jpg"))
image_no_4 = ImageTk.PhotoImage(Image.open("NewYorkStreets.jpg"))
